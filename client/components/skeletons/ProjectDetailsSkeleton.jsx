...
const ProjectDetailsSkeleton = () => {
  const skeletonClass = 'animate-pulse bg-gray-200 dark:bg-zinc-800 rounded-lg';
  const skeletonSubClass = 'animate-pulse bg-gray-100 dark:bg-zinc-700/50 rounded-lg';
  const cardClass = 'bg-white border-gray-200 shadow-sm dark:bg-dark-bg dark:border-zinc-800/80 dark:shadow-none';
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className={`rounded-2xl border p-4 ${cardClass} relative overflow-hidden shadow-sm`}>
                ...
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="h-5 w-14 rounded-full bg-gray-100 dark:bg-zinc-800 animate-pulse flex-shrink-0"></div>
                </div>
                {/* Bottom Row */}
        ...
        <div className={`lg:col-span-2 rounded-xl border ${cardClass} overflow-hidden shadow-sm relative overflow-hidden`}>
          ...
          <div className="p-4">
            <table className="w-full">
              ...
              <tbody>
                {[1, 2].map((i) => (
                  <tr key={i} className="border-b border-gray-100 last:border-b-0 dark:border-zinc-800/60">
                    ...
                    <td className="py-3 px-3 text-center"><div className="h-5 w-16 rounded-full mx-auto bg-gray-100 dark:bg-zinc-800 animate-pulse"></div></td>
                ...
                {[1, 2, 3, 4, 5].map((i) => (
                  <tr key={i} className="border-b border-gray-100 last:border-b-0 dark:border-zinc-800/60">
                    <td className="py-4 px-4 text-center">
                      <div className={`h-4 w-4 mx-auto border border-gray-300 bg-white dark:border-zinc-700 dark:bg-zinc-800/40 ${skeletonClass}`}></div>
                    </td>
                    <td className="py-4 px-4">
                      <div className="flex flex-col gap-1.5">
                        <div className="flex items-center gap-2">
                          <div className={`h-3.5 w-40 ${skeletonClass}`}></div>
                          <div className="h-4 w-14 rounded-full bg-gray-100 dark:bg-zinc-800 animate-pulse"></div>
                        </div>
                    ...
                    <td className="py-4 px-4 text-left">
                      <div className="h-6 w-20 rounded-full bg-gray-100 dark:bg-zinc-800 animate-pulse"></div>
                    </td>
                    <td className="py-4 px-4 text-left">
