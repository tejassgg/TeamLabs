...
const ProjectCardSkeleton = ({ theme, delay = 0 }) => {
  ...
  return (
    <div
      className={'bg-white border border-gray-200 rounded-xl p-4 flex flex-col h-full relative overflow-hidden dark:bg-transparent dark:border dark:border-gray-700 dark:rounded-xl dark:p-4 dark:flex dark:flex-col dark:h-full dark:relative dark:overflow-hidden'}
