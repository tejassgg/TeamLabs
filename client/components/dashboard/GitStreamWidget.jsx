        ...
        {!loading && !error && commits.map((commit, index) => (
          ...
          >
            <div className="flex items-start gap-3">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 bg-slate-100 text-slate-900 dark:bg-dark-hover dark:text-white`}>
                <FaGithub size={14} />
              </div>
              <div className="flex-1 min-w-0">
                ...
                <p className={`text-xs mt-2 break-words leading-relaxed font-mono text-slate-700 dark:text-slate-300`}>
                  {commit.message}
                </p>
