  ...
  return (
    <div className="relative">
      <button
        ...
        className={`group flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-gray-200/90 text-gray-700 dark:hover:bg-gray-600/70 dark:text-gray-200`}
      ...
      {isExpanded && (
        <div className={`absolute top-full right-0 mt-2 p-4 rounded-xl shadow-xl border z-50 min-w-72 transition-all duration-300 ease-out bg-white border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-600 dark:shadow-2xl`}>
          {/* Header */}
            ...
            {allActiveUsers.map(collaborator => {
              ...
              return (
                <div key={collaborator.userId} 
                  className={`group relative overflow-hidden bg-${actionColor}-50 dark:bg-${actionColor}-900/20 rounded-lg p-3 transition-all duration-200 hover:shadow-md`}
                >
                  ...
                  <div className="relative flex items-center gap-3">
                       ...
                       isCurrentUser
                         ? 'bg-green-400 dark:bg-green-500 text-white ring-2 ring-green-200 dark:ring-green-400/30'
                         : `bg-${actionColor}-400 dark:bg-${actionColor}-500 text-white ring-2 ring-${actionColor}-200 dark:ring-${actionColor}-400/30`
                     }`}>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className={`text-xs flex items-center gap-1 text-${actionColor}-600 dark:text-${actionColor}-300`}>
