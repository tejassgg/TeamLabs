...
const CookiePolicyModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-all duration-300">
      <div id="cookie-policy-modal" className={`relative w-full sm:max-w-5xl h-[85vh] flex flex-col overflow-hidden rounded-2xl border shadow-2xl transition-all duration-300 ${theme === 'dark'
