...
import { FaTimes, FaFileContract, FaUser, FaShieldAlt, FaExclamationTriangle, FaInfoCircle, FaGavel, FaEnvelope, FaPhone } from 'react-icons/fa';
        ...
        <div className={`sticky top-0 z-10 bg-gradient-to-r ${getThemeClasses('from-indigo-50 to-purple-50 border-b border-gray-200', 'from-gray-800 to-gray-900 border-b border-gray-700')}`}>
          <div className="flex items-center justify-between p-8">
            <div className="flex items-center">
              <div className={`w-12 h-12 rounded-xl flex items-center justify-center mr-4 ${getThemeClasses('bg-gradient-to-r from-indigo-600 to-purple-600', 'bg-gradient-to-r from-indigo-500 to-purple-500')}`}>
          ...
          <div className="p-8 space-y-10">
            ...
            <div>
              ...
              <div className={`p-6 rounded-2xl border ${getThemeClasses('bg-white border-gray-200 shadow-sm', 'bg-gray-800 border-gray-700')}`}>
                <p className={`text-lg leading-relaxed mb-4 ${getThemeClasses('text-gray-700', 'text-gray-300')}`}>
                  TeamLabs provides a comprehensive project management platform that includes:
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  <ul className={`space-y-3 ${getThemeClasses('text-gray-600', 'text-gray-300')}`}>
            ...
            <div>
              ...
              <div className={`p-6 rounded-2xl border ${getThemeClasses('bg-white border-gray-200 shadow-sm', 'bg-gray-800 border-gray-700')}`}>
                <div className="space-y-4">
                  <div>
                    <h4 className={`text-lg font-semibold mb-2 ${getThemeClasses('text-gray-900', 'text-white')}`}>
                      TeamLabs Ownership
                    </h4>
            ...
            <div>
              ...
              <div className={`p-6 rounded-2xl border ${getThemeClasses('bg-gradient-to-r from-yellow-50 to-orange-50 border-yellow-200', 'bg-gradient-to-r from-yellow-900/20 to-orange-900/20 border-yellow-700/30')}`}>
                <div className="space-y-4">
                  <p className={`text-lg leading-relaxed ${getThemeClasses('text-gray-700', 'text-gray-300')}`}>
