    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className={`relative max-w-5xl w-full max-h-[95vh] overflow-hidden rounded-3xl shadow-2xl border ${getThemeClasses('bg-white border-gray-200', 'bg-gray-900 border-gray-700')}`}>
        ...
        <div className={`sticky top-0 z-10 bg-gradient-to-r ${getThemeClasses('from-blue-50 to-indigo-50 border-b border-gray-200', 'from-gray-800 to-gray-900 border-b border-gray-700')}`}>
          <div className="flex items-center justify-between p-8">
            <div className="flex items-center">
              <div className={`w-12 h-12 rounded-xl flex items-center justify-center mr-4 ${getThemeClasses('bg-gradient-to-r from-blue-600 to-indigo-600', 'bg-gradient-to-r from-blue-500 to-indigo-500')}`}>
        ...
        <div className="overflow-y-auto max-h-[calc(95vh-200px)]">
          ...
          {/* Data Security */}
          <div>
            <h3 className={`text-xl font-semibold mb-4 flex items-center ${getThemeClasses('text-gray-900', 'text-white')}`}>
              <FaLock className="w-5 h-5 mr-2 text-red-500" />
              Data Security
            </h3>
            
            <div className={`p-6 rounded-lg ${getThemeClasses('bg-gray-50', 'bg-gray-800')}`}>
          ...
          {/* Contact Information */}
          <div className={`p-6 rounded-lg ${getThemeClasses('bg-blue-50', 'bg-blue-900/20')}`}>
            <h3 className={`text-xl font-semibold mb-4 flex items-center ${getThemeClasses('text-blue-800', 'text-blue-200')}`}>
