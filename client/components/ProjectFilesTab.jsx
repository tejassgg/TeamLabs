  ...
  return (
    <div>
        ...
        <div className="flex gap-2">
          ...
          <div className="flex border border-gray-300 rounded-lg overflow-hidden">
            <button
              ...
              className={`px-3 py-2 ${fileViewMode === 'table' ? getThemeClasses('bg-blue-500 text-white', 'dark:bg-blue-600') : getThemeClasses('bg-white text-gray-700', 'dark:bg-gray-800 dark:text-gray-300')}`}
            >
              <FaTable size={14} />
            </button>
            <button
              onClick={() => setFileViewMode('grid')}
              className={`px-3 py-2 ${fileViewMode === 'grid' ? getThemeClasses('bg-blue-500 text-white', 'dark:bg-blue-600') : getThemeClasses('bg-white text-gray-700', 'dark:bg-gray-800 dark:text-gray-300')}`}
            >
              <FaTh size={14} />
            </button>
          </div>
      ...
      {attachmentsLoading ? (
        ...
        <div>
          {fileViewMode === 'table' && (
            <div className={getThemeClasses("bg-white rounded-xl shadow", "dark:bg-gray-900")}>
