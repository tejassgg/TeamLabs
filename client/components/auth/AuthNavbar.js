      ...
      <div className="sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 w-full">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={toggleTheme}
              className={`p-2 rounded-lg transition-colors ${theme === 'dark' ? 'text-gray-400 hover:text-yellow-300 bg-gray-800 hover:bg-gray-700' : 'text-gray-600 hover:text-gray-900 bg-gray-100/10 hover:bg-gray-200'}`}
            ...
            {isAuthenticated ? (
              <button
                ...
                className={`hidden sm:inline-flex items-center px-4 py-2 border-2 rounded-lg font-semibold text-sm transition-all transform hover:scale-105 ${theme === 'dark' ? 'border-gray-600 text-gray-300 hover:bg-gray-800 hover:border-gray-500' : 'border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-gray-400'}`}
              >
              ...
              <button
                onClick={handleLogin}
                className={`hidden sm:inline-flex items-center px-4 py-2 border-2 rounded-lg font-semibold text-sm transition-all ${theme === 'dark' ? 'border-gray-600 hover:bg-gray-800 text-gray-300' : 'border-gray-300 hover:bg-gray-50 text-gray-700'}`}
              >
